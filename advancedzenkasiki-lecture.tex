...
\begin{align*}
    ...
    &\doti \dfrac{1}{a_n}=\dfrac{5\cdot4^{n-1}-2}{3}
\end{align*}
$\Y \ans{a_n=\dfrac{5\cdot4^{n-1}-2}{3}　(n\geq1)}$\\\\
...
\begin{align*}
    b_n=\dfrac{a_n+\alpha}{a_n+\beta}　(n=1,2,3,\cdots)
\end{align*}
とおく.$\B{a_n}$が等比数列となるような$\alpha と\beta\hspace{2mm}(\alpha>\beta)を1組求めよ.$\\
\kakkoni　数列$\B{a_n}の一般項\B{a_n}を求めよ.$\\
\hspace{10cm}(東北大)\newpage
\noindent\ba{2$\bullet$1}\\
\kangaekata\\
